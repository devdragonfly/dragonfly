    ...
    return (
      ...
      <div className="row question1and2">
            ...
            <div className="col-sm-10">
                  <br/>
                  <div className="divCenter"><h3>What is Dragonfly Incentivized Information?</h3>
                  <br/><br/>
                  Dragonfly is a SaaS platform that allows companies to pay customers to engage with information about their company and products. Customers are presented with information and are paid for answering questions correctly about the information, and providing their feedback. It creates an ongoing, documentable, two-way communication between companies and their customers.
                  <br/><br/>
                  <br/>
                  <div className="divCenter"><h3>Why do companies need Dragonfly?</h3></div>
                  <br/><br/>
      ...
      <div className="row question3and4">
            ...
            <div className="col-sm-10">
                <br/>
                <div className="divCenter"><h3>How do companies use Dragonfly?</h3>
                <br/><br/>
                Companies use Dragonfly any time they are sharing and requesting important information from a customer. Nearly any information that a sales rep, an ad, or an email would share can be put into a Dragonfly. Pre-sale, Dragonfly can handle qualifying and screening, asking questions and sharing information, and capturing and overcoming objections. Post sale, Dragonfly can handle product training, user adoption, new messaging, and referrals. Being able to provide uniform and consistent messaging, across all of these areas, with metrics for each customer, are some of the main values of Dragonfly.
                <br/><br/>
                <br/>
                <div className="divCenter"><h3>Is this the end of Sales Reps?</h3></div>
                <br/><br/>
      ...
      <div className="row question5and6">
            ...
            <div className="col-sm-10">
                <br/>
                <div className="divCenter"><h3>What does Dragonfly cost?</h3>
                <br/><br/>
      ...
      <div className="row question7and8">
            ...
            <div className="col-sm-10">
                <br/>
                <div className="divCenter"><h3>What is Pre-Launch?</h3>
                <br/><br/>
                ...
                <br/><br/>
                <br/>
                <div className="divCenter"><h3>How do I find out more information?</h3></div>
                <br/><br/>
                Email us at admin@dragonfly.one
                <br/><br/><br/>
                </div>
            </div>
            <div className="col-sm-1"></div>
